...
# /data1/bingling/10000_peak/20210331_ST87/20210331 negST87B-5 12um-tangzh Analyte 1 5000 lockmass.txt
# /data1/bingling/10000_peak/20210331_ST87/20210331 negST87B-5 12um-tangzh Analyte 1 5000.txt
...
def tissue_detection(df_desi, mz_tissue, to_dir, thresh=500, otsu=False, dilate_size=2, tissue_erode_size=1): 
    ...
    if otsu:
        ...
        df_tissue[df_tissue > thresh] = 10000
...
def spatialdimplot_desi(adata, label, prefix):
    ...
    col16 = ["#BFE2E3","#A1CFFA","#78BDAD","#D45651","#397A7F","#F0918E","#EEE8DA","#1F5392","#A0BFAF", 
               "#AE98D6","#ECCBDC","#54BAD3","#8b4a4b","#DB896C","#AABAC2","#ffae3b",'#03A464','#FF7F00',
               '#8968CD','#1C5B75','#B03060','#00ABDC','#D2691E']
