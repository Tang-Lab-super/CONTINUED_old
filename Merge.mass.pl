...
my $output_prefix = 'colon_cancer_desi_cytof';

my $input_sample_list = '/data/tang/desi/processing/merge.lockmass/sample.list.selected.cytof.txt';  #cytof+21
my $work_dir = '/data/tang/desi/input/combined';

my $input_lipid = '/data/tang/desi/input/LC_MS/20210930.Lipid.8_samples.uniq.txt';
my $input_small_mol = '/data/tang/desi/input/LC_MS/20220107.combined.small_molecule.neg.uniq.txt';
...
my $output_sample_mass = 'mass_dis_in_samples.cytof.txt';
...
sub Print_Clustered_Mass_By_Sample {
    ...
    my $output_tab = $output_prefix.'.clustered_mass.table.with.anno.cytof.txt';
