...
work_dir = '/data/tang/desi/input/combined'
output_prefix = '/public1/yuchen/3.DESI_project/2.Continued/3.annotation/colon_cancer_desi_'

input_lipid = '/data/tang/desi/input/LC_MS/20210930.Lipid.8_samples.uniq.txt'
input_small_mol = '/data/tang/desi/input/LC_MS/20220107.combined.small_molecule.neg.uniq.txt'

input_sample_list = '/data1/bingling/实验室电脑内容/main project/熊丹/脚本/3. github/Continued/example/Dataset/sample.list.selected.txt'
mass_cutoff = 0.02
